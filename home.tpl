...
<td><div class="badge badge-pill" id="ganper"></div></td>
              ...
              <tr><td>
              <!--div class="badge badge-outline-success badge-pill" id="labelAccount"></div--></td>
            </tr></tbody></table>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              <!--a class="dropdown-item cambiaTipo" href="/segmed.ai/" id="cambiaTipo">
                <i class="mdi mdi-refresh text-primary"></i>
                <span id="CTDR" class="CTDR">Log out</span>
              </a-->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" id="searchMedicalMenu" href="javascript:;">
              <i class="mdi mdi-briefcase menu-icon"></i>
              <span class="menu-title">Medical images</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" id="searchDisabilityMenu" href="javascript:;">
              <i class="fa fa-stethoscope"></i>
              <span class="menu-title">Disability images</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" id="searchNurseMenu" href="javascript:;">
              <i class="fa fa-ambulance"></i>
              <span class="menu-title">Nurse images</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" id="favoritesMenu" href="javascript:;">
  ...
  <script src="../static/segmed/main.js"></script>
</body>
</html>